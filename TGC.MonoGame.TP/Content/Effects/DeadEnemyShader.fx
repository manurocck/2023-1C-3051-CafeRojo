...
float4 MainPS(VertexShaderOutput input) : COLOR
{
    ...
    // Color escala de rojo que depende de las coordenadas de textura  
    float3 color = float3(1.0, 0.0, 0.0) * (coordinates.x + 1.0) / 2.0;
    ...
    // funcion que depende del tiempo (en segundos)
