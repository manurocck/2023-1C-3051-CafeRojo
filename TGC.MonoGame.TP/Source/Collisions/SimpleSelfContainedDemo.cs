...
public static class SimpleSelfContainedDemo
{
    public static void Run()
    {
        ...
        var simulation = Simulation.Create(bufferPool, new NarrowPhaseCallbacks(),
        ...
        simulation.Bodies.Add(BodyDescription.CreateDynamic(new Vector3(0, 5, 0), sphereInertia,
            simulation.Shapes.Add(sphere), 0.01f));
    ...
    public struct NarrowPhaseCallbacks : INarrowPhaseCallbacks
    {
        ...
        /// <param name="speculativeMargin">
        ///     Reference to the speculative margin used by the pair.
        ///     The value was already initialized by the narrowphase by examining the speculative margins of the involved
        ///     collidables, but it can be modified.
        /// </param>
        ...
        /// <summary>
        ///     Chooses whether to allow contact generation to proceed for the children of two overlapping collidables in a
        ///     compound-including pair.
        /// </summary>
        ...
        /// <param name="childIndexA">
        ///     Index of the child of collidable A in the pair. If collidable A is not compound, then this is
        ///     always 0.
        /// </param>
        /// <param name="childIndexB">
        ///     Index of the child of collidable B in the pair. If collidable B is not compound, then this is
        ///     always 0.
        /// </param>
        /// <returns>True if collision detection should proceed, false otherwise.</returns>
        /// <remarks>
        ///     This is called for each sub-overlap in a collidable pair involving compound collidables. If neither collidable in a
        ///     pair is compound, this will not be called.
        ///     For compound-including pairs, if the earlier call to AllowContactGeneration returns false for owning pair, this
        ///     will not be called. Note that it is possible
        ...
        /// <summary>
        ///     Provides a notification that a manifold has been created for a pair. Offers an opportunity to change the manifold's
        ///     details.
        /// </summary>
        ...
        /// <summary>
        ///     Provides a notification that a manifold has been created between the children of two collidables in a
        ///     compound-including pair.
